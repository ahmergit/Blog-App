...
const NEW_API_KEY = process.env.REACT_APP_NEWS_API_KEY

const NEW_API_ENDPOINT = `https://newsapi.org/v2/everything?q=business AND blockchain&sortBy=publishedAt&language=en&apiKey=${NEW_API_KEY}`;
